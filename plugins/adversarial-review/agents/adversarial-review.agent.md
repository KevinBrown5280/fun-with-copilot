...
8. **If not clean and `run_cycle_count < 5`**: repeat from step 2. (The fix phase in step 2 targets only open confirmed findings; the re-review in step 4 always covers the full codebase regardless.)
